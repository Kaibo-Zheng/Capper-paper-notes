...
本文以 `paper/AI4S/NucleicAcid/GEMORNA` 笔记为基础，归纳 mRNA 和 circRNA 设计中常用的评价指标。该内容有助于理解论文 *Deep generative models design mRNA sequences with enhanced translational capacity and stability* 的研究目标和评价体系，也可作为 AI4S 方向 mRNA 相关论文的通用评价参考。
